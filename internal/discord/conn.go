...
// from. They are handed out rather than built into anything, because both die
// with the session and the things that need them do not.
func (c *conn) VoiceResources() (disgovoice.Manager, *voicesink.DaveRegistry) {
