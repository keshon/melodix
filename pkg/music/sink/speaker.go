// The speaker backend: the same engine playing to a local audio device
// instead of a voice channel. It is what cmd/cli runs on, and the working
// proof that pkg/music does not know Discord exists.
